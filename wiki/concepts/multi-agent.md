...
- **[[learned-orchestration|Learned orchestration]]** — a *trained* orchestrator model coordinates a team of heterogeneous frontier workers via query-adaptive scaffolds. Canonical: [[sakana-fugu-sakana-ai-2026|Sakana Fugu]] (route/compose specialists; performance beyond any single worker) and [[agent-as-a-router-zhou-2026|Agent-as-a-Router]]. Distinct from the above: the coordination *policy itself* is learned end-to-end, and the workers are third-party models.
